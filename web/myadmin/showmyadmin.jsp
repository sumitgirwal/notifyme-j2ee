  ...
  <%
   ...
   java.sql.ResultSet rs=m.showSelfPro();
   int n=0;
%> 
 <!DOCTYPE html>
    ...
    <title>MyAdmin DashBoard | Show My User</title>
    ...
    <link href="assets/css/style.css" rel= "stylesheet">
       ...
       <div class="container">
            ...
            <div class="col-md-12"><h4 class="header-line">My User Info. :</h4><hr> </div>
                     </div>
...
<%
            ...
            while(rs.next()){
				String status=rs.getString("status");
				  ...
				  if(!(rs.getString("uid")).equalsIgnoreCase((String)session.getAttribute("myid"))){
				n++;  
          %>
		       <tr class="odd gradeX">
				...
				<td class="center"><%=rs.getString("cno")%></td>
                                ...
                                <td class="center"><a class="btn btn-danger" href="activemyadmin.jsp?uid=<%=rs.getString("uid")%> " role="button" >ACTIVE</a></td>
			        <%}else{%>
                                <td class="center"><a class="btn btn-info" href="editmyuser.jsp?uid=<%=rs.getString("uid")%> " role="button" >EDIT</a></td>
			        <%}%>
                       </tr><%} }}%>  
		    </tbody>
		   </table>
