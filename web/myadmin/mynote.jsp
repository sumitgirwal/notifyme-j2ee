...
%>
 <!DOCTYPE html>
    ...
    <title>MyAdmin DashBoard | My Notes</title>
...
<div class="alert alert-light" role="alert">  
      <form action="mynote2.jsp" method="post">
          ...
          <textarea class="form-control" id="exampleFormControlTextarea1" rows="9"  name="mynote" ><%=mynote%></textarea>    
</div>
