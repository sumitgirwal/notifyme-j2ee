	   ...
	   <br> <br> <br> <br>
                 ...
                 <div class="alert alert-light" role="alert">
                   <h4 class="alert-heading">Edit Notice Info. :</h4><hr> 
                               ...
                               <form method="post"  action="updatent2.jsp" enctype="multipart/form-data">
...
{  boolean found=o.findPrivilege(cname,rsc.getString("cname"));      
  ...
  %>  </div>            
      ...
      <div class="form-group col-md-6"> 
       ...
       <label><b>Update Date and Time </b></label><br>
        ...
        <br> <label><b>Text </b></label><br>
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="5"  name="text"  > <%=rs.getString("text")%> </textarea>    
   ...
   <br><br>      
      ...
      <a class="btn btn-outline-danger btn-lg" href="sendallemail.jsp?nid=<%=nid%>&oid=<%=oid%>&oname=<%=oname%>" role="button"  onclick="return confirm('Do You Went To Send EMail ?');" >Send Mail</a> 
