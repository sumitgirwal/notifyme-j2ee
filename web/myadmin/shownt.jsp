...
int n=0;
 ...
 <!DOCTYPE html>
    ...
    <title>MyAdmin DashBoard | Show Notices </title>
...
<%
            ...
            while(rs.next()){
                ...
                n++;
	 String status=new String(rs.getString("status"));
         ...
         String send=new String(rs.getString("send"));
          ...
          %>
		       <tr class="odd gradeX">
				...
				<td class="center"><a class="btn btn-info" href="editnt.jsp?nid=<%=rs.getString("nid")%>&oid=<%=oid%>&oname=<%=oname%>" role="button" >Edit</a></td>
			</tr><%}%>  
		    </tbody>
		   </table>
